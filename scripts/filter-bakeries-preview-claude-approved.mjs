...
const SOURCE_PREVIEW = "data/import-previews/bakeries-general-topup-preview-2026-06-29T14-48-22-672Z.json";
const OUTPUT_PREVIEW = "data/import-previews/bakeries-preview.json";
const APPROVED_BACKUP = "data/import-previews/bakeries-approved-10-import-preview-2026-06-29.json";
...
const APPROVED_NAMES = [
  ...
  "Forn La Delice",
  "Gelat Sóller",
  "Petit Cafè Frozen Yogurt",
  "La Boutique del Gelato Playa de Muro",
  "Panadería Nadal S L",
  "Pastisseria Can Tòfol Son Macià",
...
function main() {
  ...
  for (const name of APPROVED_NAMES) {
    ...
    selected.push({ ...match, category: "bakery" });
  }
  ...
  const reportPath = join(OUTPUT_DIR, `bakeries-preview-claude-approved-filter-${stamp}.md`);
  const lines = [
    "# Bakeries Preview Claude Approved Filter",
    "",
