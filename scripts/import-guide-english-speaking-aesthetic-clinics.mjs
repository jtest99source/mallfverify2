...
const en = {
  ...
  sections: [
    ...
    {
      heading: "What each clinic focuses on — according to their own websites",
      body:
        "A quick orientation layer before you shortlist, taken from each clinic's own public website in July 2026. Offerings change and this is the clinic's word, not ours — confirm details in consultation:\n\n| Clinic | Focus, per their website |\n| --- | --- |\n| **MEDISANS** (Palma) | Full-spectrum aesthetic medicine plus plastic surgery, with an unusually deep device suite (Morpheus 8, Ultherapy, CO2 laser), laser hair removal and a hair unit |\n| **Dermathos** (Palma) | Medical dermatology first — skin-cancer checks and Mohs surgery included — with aesthetic harmonisation (hyaluronic acid, botox) on top |\n| **Mara Aesthetics** (Palma) | Plastic and aesthetic surgery practice (breast, face, body) alongside wrinkle injections |\n| **The Skin Koncept** (Palma) | Injectables and collagen biostimulators, facials, body treatments and micropigmentation |\n| **GB Clinic** (Palma) | Body-contouring technology: lipolaser, cavitation, lymphatic drainage, facial radiofrequency |\n| **Luis Fogued** (Palma) | Hyaluronic-acid specialist: rhinomodelling, lip design, full facial harmonisation |\n| **MD AESTHETICS** (Santa Ponça) | Injectables-led menu — Botox, brand-name fillers, Profhilo, polynucleotides, Sculptra — plus Hydrafacial and CO2 laser |\n| **Mallorca Aesthetic Clinic** (Cala Millor) | Facial injectables and device treatments (Etherea MX laser, needle radiofrequency, Hydrafacial), minor aesthetic surgery |\n| **RB Centro Médico** (Cala Millor) | Facial medicine with PRP, tensor threads, collagen inducers and medical laser hair removal |\n| **OLIVA** (Inca) | Injectables and collagen inducers plus a hair unit (including transplants) and nutrition services |\n| **Lumina** (Alcúdia) | Botox, fillers, microneedling and peels — with a free first consultation |\n| **Clínica Font** (Sineu) | Injectables plus a broad device park (HIFU, cryolipolysis, EMS) and laser hair removal |",
      business_ids: []
    },
    {
...
const de = {
  ...
  sections: [
    ...
    {
      heading: "Worauf jede Klinik spezialisiert ist — laut eigener Website",
      body:
        "Eine schnelle Orientierung vor der Auswahl, entnommen der öffentlichen Website jeder Klinik im Juli 2026. Angebote ändern sich, und dies ist die Selbstdarstellung der Klinik, nicht unsere Bewertung — Details im Beratungsgespräch bestätigen:\n\n| Klinik | Schwerpunkt laut eigener Website |\n| --- | --- |\n| **MEDISANS** (Palma) | Ästhetische Medizin im Vollspektrum plus plastische Chirurgie, mit ungewöhnlich breiter Gerätepalette (Morpheus 8, Ultherapy, CO2-Laser), Laser-Haarentfernung und Haar-Abteilung |\n| **Dermathos** (Palma) | Medizinische Dermatologie zuerst — inklusive Hautkrebs-Vorsorge und Mohs-Chirurgie — mit ästhetischer Harmonisierung (Hyaluron, Botox) obendrauf |\n| **Mara Aesthetics** (Palma) | Praxis für plastische und ästhetische Chirurgie (Brust, Gesicht, Körper) plus Faltenunterspritzung |\n| **The Skin Koncept** (Palma) | Injectables und Kollagen-Biostimulatoren, Facials, Körperbehandlungen und Mikropigmentierung |\n| **GB Clinic** (Palma) | Body-Contouring-Technologie: Lipolaser, Kavitation, Lymphdrainage, Gesichts-Radiofrequenz |\n| **Luis Fogued** (Palma) | Hyaluron-Spezialist: Rhinomodellierung, Lippendesign, komplette Gesichtsharmonisierung |\n| **MD AESTHETICS** (Santa Ponça) | Injectables-geführtes Menü — Botox, Marken-Filler, Profhilo, Polynukleotide, Sculptra — plus Hydrafacial und CO2-Laser |\n| **Mallorca Aesthetic Clinic** (Cala Millor) | Faziale Injectables und Gerätebehandlungen (Etherea-MX-Laser, Nadel-Radiofrequenz, Hydrafacial), kleine ästhetische Chirurgie |\n| **RB Centro Médico** (Cala Millor) | Gesichtsmedizin mit PRP, Fäden-Lifting, Kollagen-Induktoren und medizinischer Laser-Haarentfernung |\n| **OLIVA** (Inca) | Injectables und Kollagen-Induktoren plus Haar-Abteilung (inklusive Transplantationen) und Ernährungsberatung |\n| **Lumina** (Alcúdia) | Botox, Filler, Microneedling und Peelings — mit kostenloser Erstberatung |\n| **Clínica Font** (Sineu) | Injectables plus breiter Gerätepark (HIFU, Kryolipolyse, EMS) und Laser-Haarentfernung |",
      business_ids: []
    },
    {
