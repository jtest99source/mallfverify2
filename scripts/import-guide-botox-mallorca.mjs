...
const en = {
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        "We only quote prices we can attribute. Several verified clinics publish their own price lists — Mara Aesthetics, for example, publishes hyaluronic-acid filler pricing from €300 per millilitre, and MD AESTHETICS maintains a full public list. We're currently collecting standardised 2026 prices directly from verified clinics and will publish the comparison table here. Until then, treat unusually cheap offers as a prompt for more questions — prescription medicine administered by a physician has a legitimate cost floor."
    }
  ],
  seo: {
...
const de = {
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        "Wir nennen nur Preise mit Quelle. Mehrere geprüfte Kliniken veröffentlichen eigene Preislisten — Mara Aesthetics etwa publiziert Hyaluron-Filler ab 300 € pro Milliliter, MD AESTHETICS führt eine komplette öffentliche Liste. Parallel sammeln wir standardisierte 2026er-Preise direkt bei den geprüften Kliniken und veröffentlichen hier die Vergleichstabelle. Bis dahin gilt: Auffällig billige Angebote sind ein Anlass für mehr Fragen — ein arztpflichtiges Apotheken-Medikament hat einen legitimen Kostenboden."
    }
  ],
  seo: {
