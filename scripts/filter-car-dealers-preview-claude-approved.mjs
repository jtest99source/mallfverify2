...
const SOURCE_PREVIEW = "data/import-previews/car-dealers-general-topup-preview-2026-06-29T14-28-35-549Z.json";
const OUTPUT_PREVIEW = "data/import-previews/car-dealers-preview.json";
const APPROVED_BACKUP = "data/import-previews/car-dealers-approved-3-import-preview-2026-06-29.json";
const OUTPUT_DIR = "reports";

const APPROVED_NAMES = [
  "Awauto Palma",
  "Renault Manacor Dibautoplus",
  "Concesionario Oficial ŠKODA - Motor Insular Mallorca"
];
...
function main() {
  ...
  for (const approvedName of APPROVED_NAMES) {
    ...
    if (match) selected.push({ ...match, category: "car-dealer" });
    else missing.push(approvedName);
  }
  ...
  const reportPath = join(OUTPUT_DIR, `car-dealers-preview-claude-approved-filter-${stamp}.md`);
  const lines = [
    "# Car Dealers Preview Claude Approved Filter",
    "",
