...
Object.assign(esCategoryCopy, {
  physiotherapists: { label: "Fisioterapia", singular: "Clínica de fisioterapia", title: "Fisioterapeutas y clínicas de fisioterapia en Mallorca", intro: "Fisioterapeutas, osteópatas y clínicas de rehabilitación en Mallorca para expats y residentes internacionales, ordenados por reseñas reales de Google. Verificación de idioma (inglés/alemán) próximamente.", metaDescription: "Fisioterapeutas y clínicas de fisioterapia en Mallorca ordenados por reseñas reales de Google. Para residentes internacionales." },
  psychologists: { label: "Psicología", singular: "Psicólogo o centro de psicología", title: "Psicólogos y centros de psicología en Mallorca", intro: "Psicólogos, psicoterapeutas y psiquiatras en Mallorca para expats y residentes internacionales que buscan terapia en su idioma. Ordenados por reseñas reales de Google. Verificación de idioma (inglés/alemán) próximamente.", metaDescription: "Psicólogos y centros de psicología en Mallorca ordenados por reseñas reales de Google. Para residentes internacionales." },
  opticians: { label: "Ópticas", singular: "Óptica u oftalmología", title: "Ópticas y oftalmólogos en Mallorca", intro: "Ópticas, optometristas y clínicas oftalmológicas en Mallorca para expats y residentes internacionales, ordenadas por reseñas reales de Google.", metaDescription: "Ópticas y oftalmólogos en Mallorca ordenados por reseñas reales de Google. Para residentes internacionales." },
  nutritionists: { label: "Nutrición", singular: "Nutricionista o dietista", title: "Nutricionistas y dietistas en Mallorca", intro: "Nutricionistas y dietistas-nutricionistas en Mallorca para expats y residentes internacionales, ordenados por reseñas reales de Google. Verificación de idioma (inglés/alemán) próximamente.", metaDescription: "Nutricionistas y dietistas en Mallorca ordenados por reseñas reales de Google. Para residentes internacionales." },
  pediatricians: { label: "Pediatría", singular: "Pediatra o clínica pediátrica", title: "Pediatras y clínicas pediátricas en Mallorca", intro: "Pediatras y clínicas pediátricas en Mallorca para familias extranjeras y residentes internacionales, ordenados por reseñas reales de Google. Verificación de idioma (inglés/alemán) próximamente.", metaDescription: "Pediatras y clínicas pediátricas en Mallorca ordenados por reseñas reales de Google. Para residentes internacionales." },
  gynecologists: { label: "Ginecología y fertilidad", singular: "Ginecología o clínica de fertilidad", title: "Ginecología y clínicas de fertilidad en Mallorca", intro: "Ginecólogos y clínicas de fertilidad y reproducción asistida en Mallorca para expats y residentes internacionales, ordenados por reseñas reales de Google. Verificación de idioma (inglés/alemán) próximamente.", metaDescription: "Ginecología y clínicas de fertilidad en Mallorca ordenadas por reseñas reales de Google. Para residentes internacionales." },
  "property-management": { label: "Gestión de propiedades", singular: "Empresa de gestión de propiedades", title: "Gestión de propiedades y alquiler vacacional en Mallorca", intro: "Empresas de property management y gestión de alquiler vacacional en Mallorca para propietarios internacionales que administran su vivienda a distancia, ordenadas por reseñas reales de Google. Verificación de idioma (inglés/alemán) próximamente.", metaDescription: "Empresas de gestión de propiedades y alquiler vacacional en Mallorca ordenadas por reseñas reales de Google. Para propietarios internacionales." },
  renovations: { label: "Reformas y arquitectura", singular: "Empresa de reformas o arquitectura", title: "Reformas, constructoras y arquitectos en Mallorca", intro: "Empresas de reformas, constructoras, arquitectos e interioristas en Mallorca para propietarios internacionales, ordenados por reseñas reales de Google. Verificación de idioma (inglés/alemán) próximamente.", metaDescription: "Reformas, constructoras y arquitectos en Mallorca ordenados por reseñas reales de Google. Para propietarios internacionales." },
  "pool-garden": { label: "Piscinas y jardinería", singular: "Empresa de piscinas o jardinería", title: "Mantenimiento de piscinas y jardinería en Mallorca", intro: "Empresas de mantenimiento de piscinas, jardinería y paisajismo en Mallorca para propietarios de villas y segundas residencias, ordenadas por reseñas reales de Google. Verificación de idioma (inglés/alemán) próximamente.", metaDescription: "Mantenimiento de piscinas y jardinería en Mallorca ordenado por reseñas reales de Google. Para propietarios de villas." }
} satisfies Partial<Record<CategorySlug, CategoryCopy>>);

Object.assign(enCategoryCopy, {
  physiotherapists: { label: "Physiotherapy", singular: "Physiotherapy clinic", title: "Physiotherapists in Mallorca", intro: "Physiotherapists, osteopaths and rehabilitation clinics in Mallorca for expats and international residents, ranked by real Google reviews. English/German language verification coming soon.", metaDescription: "Physiotherapists and physiotherapy clinics in Mallorca ranked by real Google reviews. For international residents. Language verification coming soon." },
  psychologists: { label: "Psychology", singular: "Psychologist or practice", title: "Psychologists in Mallorca", intro: "Psychologists, psychotherapists and psychiatrists in Mallorca for expats and international residents looking for therapy in their own language. Ranked by real Google reviews. English/German language verification coming soon.", metaDescription: "English/German-speaking psychologists in Mallorca ranked by real Google reviews. For international residents. Language verification coming soon." },
  opticians: { label: "Opticians", singular: "Optician or eye clinic", title: "Opticians and eye clinics in Mallorca", intro: "Opticians, optometrists and ophthalmology clinics in Mallorca for expats and international residents, ranked by real Google reviews.", metaDescription: "Opticians and eye clinics in Mallorca ranked by real Google reviews. For international residents." },
  nutritionists: { label: "Nutritionists", singular: "Nutritionist or dietitian", title: "Nutritionists and dietitians in Mallorca", intro: "Nutritionists and registered dietitians in Mallorca for expats and international residents, ranked by real Google reviews. English/German language verification coming soon.", metaDescription: "Nutritionists and dietitians in Mallorca ranked by real Google reviews. For international residents. Language verification coming soon." },
  pediatricians: { label: "Pediatricians", singular: "Pediatrician or clinic", title: "Pediatricians in Mallorca", intro: "Pediatricians and children's clinics in Mallorca for international families and residents, ranked by real Google reviews. English/German language verification coming soon.", metaDescription: "Pediatricians and children's clinics in Mallorca ranked by real Google reviews. For international families. Language verification coming soon." },
  gynecologists: { label: "Gynecology & fertility", singular: "Gynecology or fertility clinic", title: "Gynecology & fertility clinics in Mallorca", intro: "Gynecologists and fertility / assisted reproduction clinics in Mallorca for expats and international residents, ranked by real Google reviews. English/German language verification coming soon.", metaDescription: "Gynecology and fertility clinics in Mallorca ranked by real Google reviews. For international residents. Language verification coming soon." },
  "property-management": { label: "Property management", singular: "Property management company", title: "Property management in Mallorca", intro: "Property management and holiday rental management companies in Mallorca for international owners running a home remotely, ranked by real Google reviews. English/German language verification coming soon.", metaDescription: "Property management and holiday rental management in Mallorca ranked by real Google reviews. For international owners. Language verification coming soon." },
  renovations: { label: "Renovations & architects", singular: "Renovation or architecture firm", title: "Renovations, builders & architects in Mallorca", intro: "Renovation companies, builders, architects and interior designers in Mallorca for international owners, ranked by real Google reviews. English/German language verification coming soon.", metaDescription: "Renovations, builders and architects in Mallorca ranked by real Google reviews. For international owners. Language verification coming soon." },
  "pool-garden": { label: "Pools & gardening", singular: "Pool or garden company", title: "Pool & garden maintenance in Mallorca", intro: "Pool maintenance, gardening and landscaping companies in Mallorca for villa and second-home owners, ranked by real Google reviews. English/German language verification coming soon.", metaDescription: "Pool and garden maintenance in Mallorca ranked by real Google reviews. For villa owners. Language verification coming soon." }
} satisfies Partial<Record<CategorySlug, CategoryCopy>>);

Object.assign(deCategoryCopy, {
  physiotherapists: { label: "Physiotherapie", singular: "Physiotherapie-Praxis", title: "Physiotherapeuten auf Mallorca", intro: "Physiotherapeuten, Osteopathen und Reha-Kliniken auf Mallorca für Expats und internationale Bewohner, nach echten Google-Bewertungen sortiert. Sprachverifizierung (Englisch/Deutsch) demnächst.", metaDescription: "Physiotherapeuten und Physiotherapie-Praxen auf Mallorca nach echten Google-Bewertungen. Für internationale Bewohner. Sprachverifizierung in Kürze." },
  psychologists: { label: "Psychologie", singular: "Psychologe oder Praxis", title: "Psychologen auf Mallorca", intro: "Psychologen, Psychotherapeuten und Psychiater auf Mallorca für Expats und internationale Bewohner, die Therapie in ihrer Sprache suchen. Nach echten Google-Bewertungen sortiert. Sprachverifizierung (Englisch/Deutsch) demnächst.", metaDescription: "Englisch/Deutsch sprechende Psychologen auf Mallorca nach echten Google-Bewertungen. Für internationale Bewohner. Sprachverifizierung in Kürze." },
  opticians: { label: "Optiker", singular: "Optiker oder Augenklinik", title: "Optiker und Augenärzte auf Mallorca", intro: "Optiker, Optometristen und augenärztliche Kliniken auf Mallorca für Expats und internationale Bewohner, nach echten Google-Bewertungen sortiert.", metaDescription: "Optiker und Augenärzte auf Mallorca nach echten Google-Bewertungen. Für internationale Bewohner." },
  nutritionists: { label: "Ernährungsberatung", singular: "Ernährungsberater oder Diätassistent", title: "Ernährungsberater auf Mallorca", intro: "Ernährungsberater und Diätassistenten auf Mallorca für Expats und internationale Bewohner, nach echten Google-Bewertungen sortiert. Sprachverifizierung (Englisch/Deutsch) demnächst.", metaDescription: "Ernährungsberater und Diätassistenten auf Mallorca nach echten Google-Bewertungen. Für internationale Bewohner. Sprachverifizierung in Kürze." },
  pediatricians: { label: "Kinderärzte", singular: "Kinderarzt oder Praxis", title: "Kinderärzte auf Mallorca", intro: "Kinderärzte und Kinderkliniken auf Mallorca für internationale Familien und Bewohner, nach echten Google-Bewertungen sortiert. Sprachverifizierung (Englisch/Deutsch) demnächst.", metaDescription: "Kinderärzte und Kinderkliniken auf Mallorca nach echten Google-Bewertungen. Für internationale Familien. Sprachverifizierung in Kürze." },
  gynecologists: { label: "Gynäkologie & Kinderwunsch", singular: "Gynäkologie oder Kinderwunschklinik", title: "Gynäkologie & Kinderwunsch auf Mallorca", intro: "Gynäkologen und Kinderwunsch-/Reproduktionskliniken auf Mallorca für Expats und internationale Bewohner, nach echten Google-Bewertungen sortiert. Sprachverifizierung (Englisch/Deutsch) demnächst.", metaDescription: "Gynäkologie und Kinderwunschkliniken auf Mallorca nach echten Google-Bewertungen. Für internationale Bewohner. Sprachverifizierung in Kürze." },
  "property-management": { label: "Immobilienverwaltung", singular: "Immobilienverwaltung", title: "Immobilienverwaltung auf Mallorca", intro: "Immobilienverwaltungen und Ferienvermietungs-Verwalter auf Mallorca für internationale Eigentümer, die ihr Objekt aus der Ferne verwalten, nach echten Google-Bewertungen sortiert. Sprachverifizierung (Englisch/Deutsch) demnächst.", metaDescription: "Immobilienverwaltung und Ferienvermietungs-Verwaltung auf Mallorca nach echten Google-Bewertungen. Für internationale Eigentümer. Sprachverifizierung in Kürze." },
  renovations: { label: "Renovierung & Architekten", singular: "Renovierungs- oder Architekturbüro", title: "Renovierung, Bau & Architekten auf Mallorca", intro: "Renovierungsfirmen, Bauunternehmen, Architekten und Innenarchitekten auf Mallorca für internationale Eigentümer, nach echten Google-Bewertungen sortiert. Sprachverifizierung (Englisch/Deutsch) demnächst.", metaDescription: "Renovierung, Bau und Architekten auf Mallorca nach echten Google-Bewertungen. Für internationale Eigentümer. Sprachverifizierung in Kürze." },
  "pool-garden": { label: "Pools & Gartenpflege", singular: "Pool- oder Gartenfirma", title: "Poolpflege & Gartenpflege auf Mallorca", intro: "Poolpflege-, Garten- und Landschaftsbaufirmen auf Mallorca für Villen- und Zweitwohnungsbesitzer, nach echten Google-Bewertungen sortiert. Sprachverifizierung (Englisch/Deutsch) demnächst.", metaDescription: "Poolpflege und Gartenpflege auf Mallorca nach echten Google-Bewertungen. Für Villenbesitzer. Sprachverifizierung in Kürze." }
} satisfies Partial<Record<CategorySlug, CategoryCopy>>);
