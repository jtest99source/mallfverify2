...
const locationRules: Array<LocationInference & { patterns: string[] }> = [
  { area: "Port d'Alcúdia", city: "Alcúdia", municipality: "Alcúdia", patterns: ["Port d'Alcúdia", "Port d'Alcudia", "Port Alcudia", "Puerto de Alcudia", "Puerto Alcudia", "Platja d'Alcúdia", "Platja d'Alcudia"] },
  { area: "Port de Pollença", city: "Pollença", municipality: "Pollença", patterns: ["Port de Pollença", "Port de Pollenca", "Puerto Pollensa", "Puerto de Pollensa", "Port Pollensa"] },
  { area: "Port de Sóller", city: "Sóller", municipality: "Sóller", patterns: ["Port de Sóller", "Port de Soller", "Puerto de Soller", "Port Soller"] },
  { area: "Port d'Andratx", city: "Andratx", municipality: "Andratx", patterns: ["Port d'Andratx", "Puerto de Andratx", "Puerto Andratx"] },
...
const postalCodeRules: Record<string, LocationInference> = {
  ...
  "07108": { area: "Port de Sóller", city: "Sóller", municipality: "Sóller" },
  ...
  "07157": { area: "Port d'Andratx", city: "Andratx", municipality: "Andratx" },
  ...
  "07470": { area: "Port de Pollença", city: "Pollença", municipality: "Pollença" },
  ...
  "07610": { area: "Palma", city: "Palma", municipality: "Palma" },
