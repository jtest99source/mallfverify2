...
const categoryImageKeys: Record<BusinessCategory, string> = {
  ...
  lawyer: "category_activity",
  "tax-advisor": "category_activity",
  "property-management": "category_activity",
  renovations: "category_activity",
  "pool-garden": "category_activity",
...
const fallbackImageKeys: Record<BusinessCategory, string> = {
  ...
  lawyer: "fallback_activity",
  "tax-advisor": "fallback_activity",
  "property-management": "fallback_activity",
  renovations: "fallback_activity",
  "pool-garden": "fallback_activity",
