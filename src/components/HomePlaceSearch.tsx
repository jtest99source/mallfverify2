    ...
    >
      <div className="grid sm:grid-cols-2 sm:items-stretch">
        ...
        <div className={`relative px-5 py-4 sm:border-r sm:border-white/10 ${openMenu === "category" ? "z-50" : "z-40"}`}>
          ...
          {openMenu === "category" && (
            <div className="absolute left-0 top-[calc(100%+8px)] z-[90] max-h-[min(70vh,32rem)] w-full min-w-64 overflow-y-auto rounded-md border border-[#E5E7EB] bg-[#FFFFFF] p-1 shadow-[0_22px_60px_rgba(0,0,0,0.35)]">
