    ...
    <form onSubmit={handleSubmit} className="grid gap-3 md:grid-cols-[1fr_1fr]">
      ...
      <div className="md:col-span-2">
        <button
          ...
          className="min-h-12 rounded-md bg-[#07101F] px-8 py-3 text-[11px] font-bold uppercase tracking-[0.1em] text-[#FFFFFF] transition-all duration-150 hover:bg-[#0C1A2E] disabled:opacity-60"
        >
