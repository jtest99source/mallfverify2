...
export function ContactForm({ locale }: { locale: Locale }) {
  ...
  if (status === "success") {
    return (
      <div className="flex min-h-[200px] items-center justify-center rounded-lg border border-[#E5E7EB] bg-[#F9FAFB] px-8 py-10 text-center">
        <div>
  ...
  return (
    <form onSubmit={handleSubmit} className="grid gap-3">
      ...
      <button
        ...
        className="mt-1 rounded-md bg-[#0A0A0A] px-6 py-3.5 text-[11px] font-bold uppercase tracking-[0.1em] text-white transition-colors hover:bg-[#262626] disabled:opacity-60"
      >
