...
export function RatingBadge({
  ...
  if (compact) {
    return (
      <div className="inline-flex min-w-0 items-center gap-1.5 rounded-full bg-[#0A0A0A] px-2.5 py-1 text-[10px] leading-none shadow-[0_8px_18px_rgba(0,0,0,0.22)] sm:whitespace-nowrap sm:text-[11px]">
  ...
  return (
    <div className="inline-flex items-center gap-3 rounded-md bg-[#0A0A0A] px-3 py-2 text-white shadow-[0_10px_22px_rgba(10,10,10,0.20)]">
