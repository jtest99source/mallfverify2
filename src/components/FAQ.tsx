...
export function FAQ({ faqs }: { faqs: FAQType[] }) {
  ...
  return (
    <section className="mt-14">
      <h2 className="border-b-2 border-borderline pb-3 font-sans text-3xl font-bold">Preguntas frecuentes</h2>
      <div className="mt-6 border border-borderline bg-white">
        {faqs.map((faq) => (
