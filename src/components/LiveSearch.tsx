...
export function SearchBox({ locale, variant = "navbar", className = "" }: SearchBoxProps) {
  ...
  const inputClass = isHero
    ...
    : isNav
      ...
      : "h-9 w-[220px] rounded-sm border border-white/[0.12] bg-[#0C1A2E] px-9 text-[12px] text-white outline-none placeholder:text-white/60 transition-all duration-200 focus:w-[300px] focus:border-[#00C37A] focus:bg-[#0C1A2E]";
