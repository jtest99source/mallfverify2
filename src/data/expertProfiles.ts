...
const approvedDoctorProfiles: ExpertProfile[] = [
  ...
  makeApprovedPreviewProfile({ candidates: doctorsPreview, googlePlaceId: "ChIJBWydxQW7lxIR8TEOxbOmGPE", slug: "dr-esser-medical-center", verticalSlug: "english-speaking-doctors-mallorca", location: "Llucmajor", languages: ["Deutsch", "English", "Español"], focus: { es: "centro médico alemán e internacional en el sur de Mallorca", en: "German and international medical centre in southern Mallorca", de: "deutsches und internationales Ärztezentrum im Süden Mallorcas" }, specialties: medicalClinicSpecialties, clientTypes: doctorClientTypes, areasServed: ["Llucmajor", "Sur de Mallorca", "Mallorca"] }),
