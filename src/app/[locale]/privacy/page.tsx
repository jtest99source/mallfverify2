  ...
  return (
    <main className="bg-[linear-gradient(180deg,#FFF8EC_0%,#FFFDF7_100%)] px-4 py-14 sm:px-6 lg:px-8">
      <section className="mx-auto max-w-3xl rounded-md border border-[#E7DED0] bg-[#FFFDF7] p-8 shadow-[0_18px_45px_rgba(27,46,75,0.05)]">
        ...
        <h1 className="mt-3 font-sans text-5xl font-black text-[#10253D]">Política de privacidad</h1>
        <div className="mt-8 space-y-6 text-sm leading-7 text-[#4B5B4D]">
          ...
          <p>Para solicitar acceso, rectificación o eliminación de tus datos, escribe a <a href="mailto:hola@mallorcaverified.com" className="font-bold text-[#B86B1D]">hola@mallorcaverified.com</a>.</p>
        </div>
      </section>
    </main>
  );
